...
gulp.task("generate-stub", function() {
    ...
    Console.log("Generating stub for unencoded ideograph components");
    rxjs.from(ids)
        .pipe(
        ...
        .subscribe(x =>
            fs.writeFileSync(outputPath, x + "," + x + "," + "\r\n", {
                encoding: "utf8",
                flag: "as"
            })
        );

    Console.log("Generating stub for unicode characters");
    rxjs.from(ids)
        .pipe(
        ...
        .subscribe(x =>
            fs.writeFileSync(outputPath, x.codepoint + "," + x.literal + "," + "\r\n", {
                encoding: "utf8",
                flag: "as"
            })
        );
